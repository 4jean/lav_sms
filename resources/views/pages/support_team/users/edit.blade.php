...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" enctype="multipart/form-data" class="wizard-form steps-validation ajax-update" action="{{ route('users.update', Fn::hash($user->id)) }}" data-fouc>
                @csrf @method('PUT')
                <h6>Personal Data</h6>
                <fieldset>
                    <div class="row">
                    ...
                    <div class="row">
                        @if(in_array($user->user_type, Fn::getStaff()))
                            <div class="col-md-4">
                                <div class="form-group">
