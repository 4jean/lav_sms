        ...
        @if(!Qs::userIsTeacher())
            ...
            <div class="card-body collapse">
                <table class="table table-bordered table-responsive text-center">
                    ...
                    @endforeach
                    <tr>
                        <td colspan="{{ $ex->term < 3 ? 3 : 4  }}"><strong>TOTAL SCORES OBTAINED: </strong> {{ $exr->total }}</td>
                        <td colspan="{{ $ex->term < 3 ? 2 : 3  }}"><strong>FINAL AVERAGE: </strong> {{ $exr->ave }}</td>
                        <td colspan="{{ $ex->term < 3 ? 2 : 4  }}"><strong>CLASS AVERAGE: </strong> {{ $exr->class_ave }}</td>
                    </tr>
                    </tbody>
                </table>
                {{--Print Button--}}
